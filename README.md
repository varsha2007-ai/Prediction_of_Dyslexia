...
Because the dataset is small, synthetic gaze sequences were generated using controlled perturbation methods to preserve natural eye-movement behaviour while increasing training stability.A Tkinter-based graphical interface is included, allowing users to upload a fixation image, gaze CSV, or both. The system automatically chooses the appropriate model and displays the predicted class and severity level.
